	...
	return (
		isOpen && (
			<FloatingFocusManager context={floatingContext} modal={modal}>
				<div
					className={twMerge(
						'max-w-72 rounded-lg bg-background p-1 shadow-lg outline-hidden ring-1 ring-zinc-950/10 dark:bg-zinc-800 dark:ring-white/15',
						className,
					)}
...
export function HoverCardHeader(props: HeadingProps) {
	...
	return <Heading {...props} id={labelId} />
}
